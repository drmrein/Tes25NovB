...
// Type: Confins.Report.AssetDocument.AssetDocumentTableAdapters.spDOC_FormOrderPengeluaranBPKBMultiReleaseDocTableAdapter
...
namespace Confins.Report.AssetDocument.AssetDocumentTableAdapters
{
  ...
  public class spDOC_FormOrderPengeluaranBPKBMultiReleaseDocTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public spDOC_FormOrderPengeluaranBPKBMultiReleaseDocTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "spDOC_FormOrderPengeluaranBPKBMultiReleaseDoc",
        ColumnMappings = {
          {
            "RELEASE_TRX_DOC_NO",
            "RELEASE_TRX_DOC_NO"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.spDOC_FormOrderPengeluaranBPKBMultiReleaseDoc";
    ...
    public virtual int Fill(
      Confins.Report.AssetDocument.AssetDocument.spDOC_FormOrderPengeluaranBPKBMultiReleaseDocDataTable dataTable,
      long? ReleaseTrxId)
    {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual Confins.Report.AssetDocument.AssetDocument.spDOC_FormOrderPengeluaranBPKBMultiReleaseDocDataTable GetData(
      long? ReleaseTrxId)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (ReleaseTrxId.HasValue)
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
      Confins.Report.AssetDocument.AssetDocument.spDOC_FormOrderPengeluaranBPKBMultiReleaseDocDataTable releaseDocDataTable = new Confins.Report.AssetDocument.AssetDocument.spDOC_FormOrderPengeluaranBPKBMultiReleaseDocDataTable();
